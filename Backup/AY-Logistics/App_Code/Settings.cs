...
namespace AYLogistics
{
    public static class MySettings
    {
        ...
        public static string FormatePONumber(int POid)
        {
        ...
        {
            Dictionary<Object, Object> Format = GetNumberFormatSequesce(Id);
            return Format["Format"].ToString().Replace("%S%", Format["Sequence"].ToString()).Replace("%YYYY%", Convert.ToString(DateTime.Today.Year));
        }
        ...
        public static Dictionary<Object, Object> GetNumberFormatSequesce(int Id)
        {
            Dictionary<Object, Object> dictionary = new Dictionary<Object, Object>();
            string sql = @"SELECT [Format],Sequence FROM  Numbering WHERE Id=@Id";
            List<SqlParameter> list = new List<SqlParameter>();
            SqlParameter param = new SqlParameter("@Id", DbType.String);
            param.Value = Id;
            list.Add(param);
